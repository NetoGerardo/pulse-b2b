...
class EnviosController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $envios = Envio::whereContainerId($container->id)
            ->orderBy('id', 'DESC')->get();
    ...
    public function search(Request $request)
    {
        ...
        Log::info("Buscando ");
        Log::info($request->data_inicio);
        Log::info($request->data_fim);
    ...
    public function continue()
    {
        ...
        $envios = Envio::where('status_do_envio', '=', "ABERTO")
            ->where('container_id', '=', $container->id)
            ->get();

        Log::info($envios);

        return view('envios.continue', [
            "my_container" => $container,
            "my_envios" => $envios,
        ]);
    }
