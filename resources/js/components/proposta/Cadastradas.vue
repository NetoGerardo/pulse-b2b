                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input readonly="true" id="dataInicio" class="form-control" name="dataInicio"
                                    type="date" v-model="proposta_selecionada.data_vencimento" />
                            </div>
                            ...
                            <br />
                            <button data-toggle="modal" style="border-radius:7%; width:100%"
                                data-target="#detalhes-modal" @click="show(proposta)" type="button"
