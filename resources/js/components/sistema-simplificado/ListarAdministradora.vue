<template>
    <div>
        <admin-cadastrar-administradoras />
        <div class="card-body p-0">
            <table class="table">
                ...
                <tbody>
                    <tr v-for="administradora in administradoras" :key="administradora">
                        <td data-label="Nome">{{ administradora.nome }}</td>

                        <td>
                            <button data-toggle="modal" data-target="#detalhes-modal" @click="show(administradora)"
                        ...
                        <td>
                            <button @click="deletar(administradora)" type="button" class="btn btn-danger btn-sm">
                                Deletar
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="nome" type="text"
                                    v-model="administradora_selecionada.nome" />
                            </div>
...
export default {
    ...
    methods: {
        ...
        show(administradora) {
            this.administradora_selecionada = administradora;
        },
        ...
        deletar(administradora) {
            ...
            this.$swal
                .fire({
                    title: "<h3 style='color:#616060'>Deseja deletar a administradora<b><br/>" + this.administradora_selecionada.nome + "</b>? </h3>",
                    icon: "warning",
                    padding: '1.5em',
                ...
                .then(result => {
                    if (result.value) {
                        ...
                        let data = {
                            id: this.administradora_selecionada.id
                        }

                        axios
                            .post(`/admin/administradora/delete`, data)
                            .then((response) => {

                                this.showSuccessMessage("Administradora deletada!");
        ...
        update() {
            ...
            let data = {
                id: this.administradora_selecionada.id,
                nome: this.administradora_selecionada.nome,
            };
            ...
            axios
                .post(`/admin/administradora/update`, data)
                .then((response) => {
