    ...
    <div>
        ...
        <div class="card-body p-0">
            <table class="table">
                ...
                <tbody>
                    <tr v-for="operadora in operadoras" :key="operadora">
                        <td data-label="Nome">{{ operadora.nome }}</td>

                        <td>
                            <button data-toggle="modal" data-target="#detalhes-modal" @click="show(operadora)"
                        ...
                        <td>
                            <button @click="deletar(operadora)" type="button" class="btn btn-danger btn-sm">
                                Deletar
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="nome" type="text"
                                    v-model="operadora_selecionada.nome" />
                            </div>
...
export default {
    ...
    methods: {
        ...
        show(administradora) {
            this.operadora_selecionada = administradora;
        },
        ...
        deletar(administradora) {
            ...
            this.$swal
                .fire({
                    title: "<h3 style='color:#616060'>Deseja deletar a operadora<b><br/>" + this.operadora_selecionada.nome + "</b>? </h3>",
                    icon: "warning",
                    padding: '1.5em',
                ...
                .then(result => {
                    if (result.value) {
                        ...
                        let data = {
                            id: this.operadora_selecionada.id
                        }

                        axios
                            .post(`/admin/operadora/delete`, data)
                            .then((response) => {
        ...
        update() {
            ...
            let data = {
                id: this.operadora_selecionada.id,
                nome: this.operadora_selecionada.nome,
            };
