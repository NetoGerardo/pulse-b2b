<template>
    <div>
        <admin-cadastrar-status-proposta />
        <div class="card-body p-0">
            <table class="table">
                ...
                <tbody>
                    <tr v-for="status_proposta in status" :key="status">
                        <td data-label="Nome">{{ status_proposta.nome }}</td>

                        <td>
                            <button data-toggle="modal" data-target="#detalhes-modal" @click="show(status_proposta)"
                        ...
                        <td>
                            <button @click="deletar(status_proposta)" type="button" class="btn btn-danger btn-sm">
                                Deletar
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <h4>Editar status proposta</h4>
                            <br />
                            <div class="form-group">
                                <label for="email">Nome</label>
                                <input class="form-control" id="nome" type="text"
                                    v-model="status_proposta.nome" />
                            </div>
...
export default {
    ...
    methods: {
        ...
        show(status_proposta) {
            this.status_proposta = status_proposta;
        },

        deletar(status_proposta) {
            this.status_proposta = status_proposta;

            this.$swal
                .fire({
                    title: "<h3 style='color:#616060'>Deseja deletar o status <b><br/>" + this.status_proposta.nome + "</b>? </h3>",
                    icon: "warning",
                    padding: '1.5em',
                ...
                .then(result => {
                    if (result.value) {
                        ...
                        let data = {
                            id: this.status_proposta.id
                        }

                        axios
                            .post(`/admin/proposta-status/delete`, data)
                            .then((response) => {

                                this.showSuccessMessage("Status deletado!");
        ...
        update() {
            ...
            let data = {
                id: this.status_proposta.id,
                nome: this.status_proposta.nome,
            };
            ...
            axios
                .post(`/admin/proposta-status/update`, data)
                .then((response) => {

                    this.showSuccessMessage("Administradora atualizado!");
