    ...
    <div class="card">
      ...
      <div class="card-body table-responsive p-0">
        <table class="table table-hover">
          ...
          <tbody>
            <tr v-for="(tarefa, index) in tarefas" :key="tarefa">
              <td>
                {{ tarefa.tarefa.nome }}
              </td>

              <td>
                {{ formatOnlyDate(tarefa.expira_em) }}
              </td>
              ...
              <td>
                {{ tarefa.contato.status }}
              </td>

              <td>
                <button type="submit" class="btn btn-danger" @click="deletarTarefa" style="margin-left: 15px">
                  <i class="fa-solid fa fa-trash" style="margin-right: 5px"></i>
                </button>
              </td>
            </tr>
          </tbody>
