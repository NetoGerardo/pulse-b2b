    ...
    <div>
        ...
        <div class="card-body p-0">
            <table class="table">
                ...
                <tbody>
                    <tr v-for="origem in origens" :key="origem">
                        <td data-label="Nome">{{ origem.nome }}</td>
                        <td data-label="Data">
                            {{ formatDate(origem.created_at) }}
                        </td>
                        <td data-label="categoria">{{ origem.categoria }}</td>
                        <td>
                            <button data-toggle="modal" data-target="#detalhes-modal" @click="show(origem)"
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="nome" type="text" v-model="origem_selecionada.nome"
                                    autocomplete="name" />
                            </div>

                            <div class="form-group">
                                <label for="user_type">Categoria</label>
                                <select class="form-control" id="user_type" v-model="origem_selecionada.categoria">
                            ...
                            <button class="btn btn-danger btn-flat" @click="deletarOrigem()">
...
export default {
    ...
    methods: {
        ...
        show(origem) {
            this.origem_selecionada = origem;
        },

        deletarOrigem() {
            this.$swal
                .fire({
                    title: "<h2 style='color:#616060'>Deseja deletar esta origem? <b>" + this.origem_selecionada.nome + "</b></h2>",
        ...
        deletar() {
            ...
            let data = {
                id: this.origem_selecionada.id
            }

            axios
                .post(`/admin/origem/delete`, data)
                .then((response) => {

                    this.showSuccessMessage("Origem deletada!");
        ...
        update() {
            ...
            let data = {
                id: this.origem_selecionada.id,
                nome: this.origem_selecionada.nome,
                categoria: this.origem_selecionada.categoria,
            };

            axios
                .post(`/admin/origem/update`, data)
                .then((response) => {
                    this.showSuccessMessage("Origem atualizada!");
